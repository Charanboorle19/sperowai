...
const Reports = ({ onCloseCaseClick, onFollowupScheduled, isChatActive }) => {
  ...
  return (
    <div className={`w-full ${window.innerWidth > 700 ? 'max-w-full px-8' : 'max-w-2xl px-2'} mx-auto sm:px-4 relative`}>
      {/* Fixed Navigation */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-[#F8FAFC] shadow-sm">
        <div className={`${window.innerWidth > 700 ? 'max-w-full px-8' : 'max-w-2xl px-2'} mx-auto py-4 sm:px-4`}>
      ...
      {/* Content Section */}
      <div className={`${isChatActive ? 'blur-sm' : ''}`}>
